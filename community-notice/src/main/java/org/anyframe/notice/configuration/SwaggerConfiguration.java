...
package org.anyframe.notice.configuration;
...
public class SwaggerConfiguration {
	...
	public ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder().title("SSC Notice API").description("SSC Notice API").contact("SSC").license("SSC")
				.version("1.0").build();
