...
public class SimpleCORSFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        if("http://localhost:9090".equals(request.getRequestURL())){
        ...
        response.setHeader("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept, Authorization, link, X-XSRF-TOKEN");
